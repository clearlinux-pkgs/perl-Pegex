...
Source0  : https://cpan.metacpan.org/authors/id/I/IN/INGY/Pegex-0.65.tar.gz
...
VERSION
This document describes Pegex version 0.65.
...
%prep
%setup -q -n Pegex-0.65
cd ..
%setup -q -T -D -n Pegex-0.65 -b 1
mkdir -p deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Pegex-0.65/deblicense/
