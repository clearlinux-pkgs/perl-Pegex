...
Source0  : https://cpan.metacpan.org/authors/id/I/IN/INGY/Pegex-0.64.tar.gz
...
VERSION
This document describes Pegex version 0.64.

%package man
Summary: man components for the perl-Pegex package.
Group: Default

%description man
man components for the perl-Pegex package.


%prep
tar -xf %{SOURCE1}
cd ..
%setup -q -n Pegex-0.64
mkdir -p %{_topdir}/BUILD/Pegex-0.64/deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Pegex-0.64/deblicense/
