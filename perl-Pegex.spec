...
Source0  : https://cpan.metacpan.org/authors/id/I/IN/INGY/Pegex-0.72.tar.gz
...
VERSION
This document describes Pegex version 0.72.
...
%prep
%setup -q -n Pegex-0.72
cd %{_builddir}
tar xf %{_sourcedir}/libpegex-perl_0.67-2.debian.tar.xz
cd %{_builddir}/Pegex-0.72
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Pegex-0.72/deblicense/
...
cp %{_builddir}/Pegex-0.72/LICENSE %{buildroot}/usr/share/package-licenses/perl-Pegex/19d40da3bc981cec880a2112a7e2646d480cb6f4
if test -f Makefile.PL; then
